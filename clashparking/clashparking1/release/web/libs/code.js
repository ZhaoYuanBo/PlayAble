    ...
    (function (platform) {
        ...
        */
        var QQPlatform = /** @class */ (function (_super) {
            ...
            QQPlatform.prototype.init = function () {
                _super.prototype.init.call(this, {});
                this.initGameSkin();
                EventManager.ins.event(NoticeEvent.PLATFORM_INIT_OVER);
                Laya.Browser.window.gameStart = function () { platform.PlatformManager.ins.actionCallBack(platform.PlatformAction.GameStart); };
            };
            QQPlatform.prototype.initGameSkin = function () {
            };
            QQPlatform.prototype.login = function () {
                platform.PlatformManager.ins.actionCallBack(platform.PlatformAction.GameReady);
                this.loginSuccess();
            };
            QQPlatform.prototype.loginSuccess = function () {
                console.log("QQ 登录成功！");
                EventManager.ins.event(NoticeEvent.PLATFORM_LOGIN_SUCCESS);
            };
            /**
             * 获取过审状态
             */
            QQPlatform.prototype.getSwitchState = function () {
                return true;
            };
            QQPlatform.prototype.initItem = function () {
            };
            QQPlatform.prototype.saveItem = function (ID, count, type) {
                //HttpManager.ins.updateItem(ID,count,type);
            };
            QQPlatform.prototype.scoreUp = function (rank, score) {
                _super.prototype.scoreUp.call(this, rank, score);
                if (rank == 1) {
                    Laya.timer.once(200, this, this.firstUp);
                }
            };
            QQPlatform.prototype.firstUp = function () {
            };
            return QQPlatform;
        }(platform.LocalPlatform));
...
(function (game) {
    ...
    (function (platform) {
        ...
        * TikTok 国内平台 https://ads.tiktok.com
        2020-09-23 andy
        */
        var TiktokPlatform = /** @class */ (function (_super) {
            __extends(TiktokPlatform, _super);
            ...
            TiktokPlatform.prototype.initGameSkin = function () {
            };
            TiktokPlatform.prototype.login = function () {
                platform.PlatformManager.ins.actionCallBack(platform.PlatformAction.GameReady);
                this.loginSuccess();
            };
            TiktokPlatform.prototype.loginSuccess = function () {
             ...
             * 获取过审状态
             */
            TiktokPlatform.prototype.getSwitchState = function () {
                return true;
            };
            TiktokPlatform.prototype.initItem = function () {
            };
            TiktokPlatform.prototype.saveItem = function (ID, count, type) {
                //HttpManager.ins.updateItem(ID,count,type);
            };
            TiktokPlatform.prototype.scoreUp = function (rank, score) {
                _super.prototype.scoreUp.call(this, rank, score);
                if (rank == 1) {
                    Laya.timer.once(200, this, this.firstUp);
                }
            };
            TiktokPlatform.prototype.firstUp = function () {
            };
