...
var FBox = /** @class */ (function (_super) {
    ...
    function FBox(pos) {
        ...
        _this.effMine1 = FrameManager.ins.getFrame(14);
        _this.effMine1.setInterval(50);
        _this.setLineNum(1);
    ...
    FBox.prototype.init = function (id, type) {
        ...
        this.id = id;
        this.boxType = type;
        this.boxImg2.scale(0.8, 0.8);
        if (this.id == 4) {
            this.boxImg2.pos(208, 595);
        }
        else if (this.id == 5) {
            this.boxImg2.pos(-9, 391);
        }
        else if (this.id == 6) {
            this.boxImg2.pos(422, 389);
        }
        else if (this.id == 3) {
            this.boxImg2.pos(203, 199);
        }
        switch (type) {
            case fBoxType.mine:
                this.upTime = 400;
        ...
        this.boxTextUpnumber.stroke = 5;
        this.boxTextUpnumber.strokeColor = "#000000";
        ...
        this.lineImg.visible = false;
        var nu = 0;
        Laya.timer.loop(200, this.lineImg, function () {
            if (_this.isBinding) {
                nu++;
                if (nu % 3 == 0) {
                    _this.lineImg.skin = "game/arrow2.png";
                }
                else {
                    _this.lineImg.skin = "game/arrow.png";
                }
            }
            else {
                _this.lineImg.skin = "game/arrow3.png";
            }
        });
        ...
        Laya.timer.loop(200, this.lineImg, function () {
            if (_this.isBinding2) {
                num2++;
                if (num2 % 3 == 0) {
                    _this.lineImg2.skin = "game/arrow2.png";
                }
                else {
                    _this.lineImg2.skin = "game/arrow.png";
                }
            }
            else {
                _this.lineImg2.skin = "game/arrow3.png";
            }
        });
        this.boxImg.addChild(this.boxTextUpnumber);
        this.scale(1, 1);
        this.addChild(this.effUp);
        this.effMine1.pos(this.boxImg2.width >> 1, this.boxImg2.height >> 1);
        // this.addChild(this.effMine2);
        // this.addChild(this.effMine3);
                ...
                case fBoxType.other:
                    ...
                    if (_this.id == 3) {
                        if (_this.mUpNumber == 35) {
                            _this.boxImg2.skin = "game/other2.png";
                            _this.effUp.playFrame(false, _this, true);
                        }
                        else if (_this.mUpNumber == 40) {
                            _this.boxImg2.skin = "game/other3.png";
                            _this.effUp.playFrame(false, _this, true);
                        }
                    }
                    //数值增长逻辑  65封顶
    ...
    FBox.prototype.setSkin = function (type, num) {
        switch (type) {
            case fBoxType.mine:
                if (this.id == 4) {
                    this.boxImg2.skin = "game/mine_1.png";
                }
                else if (this.id == 5) {
                    this.boxImg2.skin = "game/mine_1.png";
                }
                ...
                this.effMine1.playFrame(true, this.boxImg2, false);
                this.effMine1.pos(this.boxImg2.width >> 1, this.boxImg2.height >> 1);
                break;
            case fBoxType.other:
                this.boxImg2.skin = "game/other2.png";
                break;
            case fBoxType.defult:
                if (this.id == 5) {
                    this.boxImg2.skin = "game/left1_1.png";
                }
                else if (this.id == 6) {
                    this.boxImg2.skin = "game/right1_1.png";
                }
                break;
        }
    };
