...
class FBox extends Laya.Sprite {
    ...
    public effMine1: BaseFrame;
    public effMine2: BaseFrame;
    public effMine3: BaseFrame;
    ...
    constructor(pos: number) {
        ...
        this.effMine1 = FrameManager.ins.getFrame(14);
        this.effMine1.setInterval(50);
        this.setLineNum(1);
    ...
    public init(id: number, type: fBoxType) {
        ...
        var nu = 0;
        Laya.timer.loop(200, this.lineImg, () => {
            if (this.isBinding) {
                nu++; if (nu % 3 == 0) {
                    this.lineImg.skin = "game/arrow2.png";
                } else {
                    this.lineImg.skin = "game/arrow.png";
                }
            }
            else {
                this.lineImg.skin = "game/arrow3.png";
            }
        ...
        Laya.timer.loop(200, this.lineImg, () => {
            if (this.isBinding2) {
                num2++; if (num2 % 3 == 0) {
                    this.lineImg2.skin = "game/arrow2.png";
                } else {
                    this.lineImg2.skin = "game/arrow.png";
                }
            }
            else{ 
                this.lineImg2.skin = "game/arrow3.png";
            }
                ...
                case fBoxType.other:
                    ...
                    if (this.id == 3) {
                        ...
                        if (this.mUpNumber == 35) {
                            ...
                            this.boxImg2.skin = "game/other3.png";
                            this.effUp.playFrame(false, this, true);
                        }
