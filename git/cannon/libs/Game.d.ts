...
declare module game.common {
    ...
    */
    class LayerManager{
         ...
         * @param layerNum 
         */
        public removeChild(child: laya.ui.View,layerNum?:LayerName):laya.display.Node;
        /**
         * 删除某层的全部对象
         * @param layerNum
         */
    ...
    */
    ...
    export class BodyDiv{
        ...
        public static H_BASE64_LOGO:string;
        /**横屏时下载按钮Base64数据，不填写则不处理 */
        public static H_BASE64_DOWNLOAD:string;
        /**横屏时背景色 */
        public static H_BODY_BACKGROUND_COLOR:string;
    }
    /*
    *2019-04-28 andy 
    公用工具方法
...
declare module game{
    ...
    */
    class Define{
        ...
        /**点击按钮时的声音 */
        public static SOUND_MAIN:string;
        /**点击按钮时的声音 */
        public static SOUND_GAME:string;
...
declare module game.base64{
    ...
    */
    export class Base64Manager{
         ...
         * @param base64Type 
         */
        public autoCheck(img:any,base64Type:Base64Type):void;
    }
    /*
    * 2019-04-28 andy
    BASE64单个图片类型
    */
    export class Base64Type{
        ...
        constructor(id:string,base64Img:string,base64Json?:string);
    }
}
...
import LayerManager = game.common.LayerManager;
import LayerName = game.common.LayerName;
import SceneManager = game.common.SceneManager;
import BodyDiv = game.common.BodyDiv;
