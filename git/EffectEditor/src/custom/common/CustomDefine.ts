...
class CustomDefine{
    ...
    /**配置数据HTTP地址 */
    static dataConfigUrl:string=Define.CDN+"/config/cfg_data.json";
    ...
    /**事件：警告红蓝灯 */
    public static EVENT_LIGHT:string = "EVENT_LIGHT";

    //自定义动画------------------
    public static animGuide:string="guide";
    public static animGuideDesc:string="guideDesc";
    public static animShake:string="animShake";
    public static animHeadShake:string="animHeadShake";
    public static animDanger:string="animDanger";
}
...
class LocalKey{
    ...
    /**当前使用的武器ID */
    public static GUN_ID:string = "GUN_ID";
} 
