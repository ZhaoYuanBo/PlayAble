    ...
    private loadRes():void{
        if(Base64Manager.isUseBase64){
            let arrAtlas:Array<Base64Type>=[
                ...
                CustomBase64.atlas_frame1,
                CustomBase64.atlas_frame2,
                CustomBase64.atlas_frame3,
            ...
            let arr=[{
                ...
                url:Define.CDN+"/atlas/frame1.atlas",
                type:Laya.Loader.ATLAS
            },{
                url:Define.CDN+"/atlas/frame2.atlas",
                type:Laya.Loader.ATLAS
            },{
                url:Define.CDN+"/atlas/frame3.atlas",
                type:Laya.Loader.ATLAS
            },{
                url:Define.CDN+"/atlas/effect.atlas",
                type:Laya.Loader.ATLAS
            },{
