...
export class UtilTween3D {
    ...
    /** 目标初始位移 */
    private lposX: number;
    private lposY: number;
    private lposZ: number;
    ...
    constructor(target: Laya.Sprite3D, vect3: Laya.Vector3, type: string) {
        ...
        this.lposX = target.transform.localPosition.x;
        this.lposY = target.transform.localPosition.y;
        this.lposZ = target.transform.localPosition.z;
    ...
    private onUpdate() {
        if (this.tweenType == "position") {
            ...
            this.target.transform.localPosition = new Laya.Vector3(this.lposX + this.targetVect3.x * this.mult,
                this.lposY + this.targetVect3.y * this.mult, this.lposZ + this.targetVect3.z * this.mult);
        } else if (this.tweenType == "jumpPosition") {
            this.target.transform.position = new Laya.Vector3(this.posX + this.targetVect3.x * this.mult,
                this.posY + this.targetVect3.y * this.mult, this.posZ + this.targetVect3.z * this.mult);
        }
    ...
    onComplete() {
        ...
        if (this.tweenType == "jumpPosition") {
            let aa = new Laya.Vector3(this.posX, this.posY, this.posZ)
            // console.log(aa);
            this.target.transform.position = aa;
        ...
        if (this.completeHandler != null) {
            ...
            // console.log(this.completeHandler.args);
            // this.completeHandler.runWith(this.completeHandler.args);
        }
    }
